...
We need to the add the following to `res/values/strings.xml` as they are
used in the code changes above.
...
![](./screenshots/stage_4.png "Stage 4 Phone"){width="35%"}
![](./screenshots/stage_4_tab.png "Stage 4 Tablet"){width="60%"}
